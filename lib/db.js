...
async function initDb() {
  ...
  await pool.query(`
    ...
    ALTER TABLE bookings ADD COLUMN IF NOT EXISTS allotted_room_id TEXT NOT NULL DEFAULT '';
    ALTER TABLE bookings ADD COLUMN IF NOT EXISTS allotted_room_label TEXT NOT NULL DEFAULT '';
  `);
