...
export function buildInvoiceBuffer(booking) {
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.text(`Referral Doctor: ${booking.referralDoctor || 'N/A'}`);
    ...
    doc
      ...
      .fillColor('#4b5b58')
      .text(
        'Cancellation policy: Confirmed bookings and payments are non-refundable. ' +
          'Kindly review your dates and details carefully before booking.'
      );
    doc.moveDown(0.4);
